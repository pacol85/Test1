...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\UnoCore\1.0.11\targets\android\uno\base\$.uno
// -----------------------------------------------------------------------------------------------
...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("../../AppData/Local/Fusetools/Packages/UnoCore/1.0.11/targets/android/uno/base/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"../../AppDa...*/], 318, uArray::New(::TYPES[1/*object[]*/], 0));
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"../../AppDa...*/], 131, uArray::New(::TYPES[1/*object[]*/], 0));
    jclass result;
