...
// {
// static TextView() :6
static void TextView__cctor_3_fn(uType* __type)
{
}
...
static void TextView_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(::g::Fuse::Controls::TextInputControl_type, interface8),
...
::g::Fuse::Controls::TextInputControl_type* TextView_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextInputControl_type*)uClassType::New("hikr.TextView", options);
    type->fp_build_ = TextView_build;
    type->fp_ctor_ = (void*)TextView__New4_fn;
    type->fp_cctor_ = TextView__cctor_3_fn;
...
void TextView::InitializeUX()
{
    ...
    temp->CornerRadius(::g::Uno::Float4__New2(4.0f, 4.0f, 4.0f, 4.0f));
