...
static void MainView_build(uType* type)
{
    ...
    ::STRINGS[87] = uString::Const("splash");
...
void MainView::InitializeUX()
{
    ...
    temp20->DefaultPath(::STRINGS[87/*"splash"*/]);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp20->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), splash);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp20->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), editHike);
...
// public MainView New() [static] :178
