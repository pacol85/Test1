// This file was generated based on '.uno/ux11/hikr.Page.g.uno'.
...
::g::Fuse::Controls::Panel_type* Page_typeof()
{
    ...
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("hikr.Page", options);
...
void Page::InitializeUX()
{
    ...
    temp->Opacity(0.7f);
    temp->Layer(1);
    temp->File(::g::Uno::UX::BundleFileSource::New1(::g::Test1_bundle::background15c09ed3()));
