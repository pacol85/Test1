...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.0.2\input\$.uno
// ------------------------------------------------------------------------------
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.0.2\\input\\$.uno");
...
void Gesture::OnPointerMoved(uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Missing Los...*/], this, ::STRINGS[6/*"C:\\Users\\...*/], 692, ::STRINGS[7/*"OnPointerMo...*/]);
        LostCapture(true);
        return;
    }
...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Capture can...*/], NULL, ::STRINGS[6/*"C:\\Users\\...*/], 1526, ::STRINGS[16/*"ModifyCapture"*/]);
        return false;
    }
    ...
    if (c != NULL)
    {
        if (uPtr(c)->Visual() != visual)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Cannot modi...*/], identity, ::STRINGS[6/*"C:\\Users\\...*/], 1537, ::STRINGS[16/*"ModifyCapture"*/]);
    }
    else
    {
