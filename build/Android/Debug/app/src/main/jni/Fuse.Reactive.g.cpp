...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Reactive.JavaScript\1.0.2\$.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Reactive.Expressions\1.0.2\$.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Reactive.Bindings\1.0.2\$.uno
// ------------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\1.0.2\\$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[4/*"JavaScript ...*/], ex, this, ::STRINGS[5/*"C:\\Users\\...*/], 207, ::STRINGS[6/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Reactive.JavaScript\1.0.2\fusejs\$.uno
// ---------------------------------------------------------------------------------------------
...
{
    ::STRINGS[12] = uString::Const("../../AppData/Local/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.2/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"../../AppDa...*/], 135);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"../../AppDa...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.Bindings\\1.0.2\\$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[32/*"C:\\Users\\...*/], 409, ::STRINGS[34/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Reactive.Bindings\1.0.2\subscription\$.uno
// -------------------------------------------------------------------------------------------------
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"../../AppDa...*/], 99);
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Reactive\1.0.2\$.uno
// ---------------------------------------------------------------------------
...
{
    ::STRINGS[41] = uString::Const("Template contains a non-Node");
    ::STRINGS[32] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.Bindings\\1.0.2\\$.uno");
    ::STRINGS[42] = uString::Const("AddTemplate");
    ::STRINGS[17] = uString::Const("");
    ::STRINGS[43] = uString::Const("Limit cannot be less than 0");
    ::STRINGS[44] = uString::Const("set_Limit");
    ::STRINGS[45] = uString::Const("Offset cannot be less than 0");
    ::STRINGS[46] = uString::Const("set_Offset");
    ...
    ::TYPES[50] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1/*IndexOf<Fuse.Node>*/, ::TYPES[38/*Fuse.Node*/], NULL);
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[41/*"Template co...*/], this, ::STRINGS[32/*"C:\\Users\\...*/], 1588, ::STRINGS[42/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Limit canno...*/], this, ::STRINGS[32/*"C:\\Users\\...*/], 1078, ::STRINGS[44/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Offset cann...*/], this, ::STRINGS[32/*"C:\\Users\\...*/], 1030, ::STRINGS[46/*"set_Offset"*/], NULL);
        value = 0;
    }
...
{
    ::STRINGS[47] = uString::Const("exports");
    ::STRINGS[48] = uString::Const("JavaScript error in ");
    ::STRINGS[49] = uString::Const(" fixed!");
    ::STRINGS[5] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\1.0.2\\$.uno");
    ::STRINGS[50] = uString::Const("EvaluateModule");
    ::STRINGS[51] = uString::Const("JavaScript error");
    ::STRINGS[52] = uString::Const("Cannot require() a rooted module");
    ::STRINGS[53] = uString::Const(" in ");
    ::STRINGS[54] = uString::Const(" line ");
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
...
uObject* JavaScript::EvaluateExports()
{
    ...
    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[47/*"exports"*/]);
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[48/*"JavaScript ...*/], FileName()), ::STRINGS[49/*" fixed!"*/]), this, ::STRINGS[5/*"C:\\Users\\...*/], 447, ::STRINGS[50/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[51/*"JavaScript ...*/], se, this, ::STRINGS[5/*"C:\\Users\\...*/], 463, ::STRINGS[50/*"EvaluateMod...*/]);
...
void JavaScript::UserScriptError(uString* msg, ::g::Fuse::Scripting::ScriptException* ex, uObject* obj, uString* filePath, int lineNumber, uString* memberName)
{
    ...
    msg = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(msg, ::STRINGS[53/*" in "*/]), uPtr(ex)->FileName()), ::STRINGS[54/*" line "*/]), uBox<int>(::TYPES[19/*int*/], uPtr(ex)->LineNumber()));
...
{
    ::STRINGS[55] = uString::Const(" (ScriptMethod)");
    ::STRINGS[56] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[57] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
...
void ThreadWorker__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _m = m;
    _worker = worker;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[55/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[56/*"(function (...*/], uPtr(m)->Name), ::STRINGS[57/*" = function...*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[58] = uString::Const("Named object not found: ");
    ::TYPES[27] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
    type->SetFields(0,
...
void Name__GetValue_fn(Name* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[58/*"Named objec...*/], __this->Identifier())));
}
...
static void ObjectMirror_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ::TYPES[10] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[63] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
...
{
    ::STRINGS[59] = uString::Const("addSubscriber");
    ::STRINGS[60] = uString::Const("set");
    ::STRINGS[61] = uString::Const("clear");
    ::STRINGS[62] = uString::Const("newAt");
    ::STRINGS[63] = uString::Const("newAll");
    ::STRINGS[64] = uString::Const("add");
    ::STRINGS[65] = uString::Const("removeAt");
    ::STRINGS[66] = uString::Const("insertAt");
    ::STRINGS[67] = uString::Const("removeRange");
    ::STRINGS[68] = uString::Const("insertAll");
    ::STRINGS[69] = uString::Const("failed");
    ::STRINGS[70] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[71] = uString::Const("removeSubscriber");
...
void Observable::ctor_2(::g::Fuse::Reactive::ThreadWorker* worker, ::g::Fuse::Scripting::Object* obj, bool supressCallback)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[59/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[22/*bool*/], supressCallback)));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[63/*"newAll"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[69/*"failed"*/]))
        uPtr(_worker)->Enqueue(Observable__Failed::New1(this, uAs<uString*>(uPtr(args)->Strong<uObject*>(3), ::TYPES[23/*string*/])));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[70/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[71/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    ::STRINGS[72] = uString::Const("this._raw_");
    ::STRINGS[73] = uString::Const("this._");
    ::STRINGS[74] = uString::Const(" (ScriptProperty)");
    ::STRINGS[75] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[76] = uString::Const("', ");
    ::STRINGS[26] = uString::Const("{");
    ::STRINGS[77] = uString::Const("get: function() { ");
    ::STRINGS[78] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[79] = uString::Const("if (");
    ::STRINGS[80] = uString::Const(" != obs) {");
    ::STRINGS[81] = uString::Const(" = obs;");
    ::STRINGS[82] = uString::Const(" = obs");
    ::STRINGS[83] = uString::Const(";");
    ::STRINGS[27] = uString::Const("}");
    ::STRINGS[84] = uString::Const("return ");
    ::STRINGS[85] = uString::Const("})");
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[68] = ::g::Uno::UX::PropertyObject_typeof();
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _worker = worker;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[72/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[73/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[74/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[75/*"(function(c...*/], p->Name), ::STRINGS[76/*"', "*/]), ::STRINGS[26/*"{"*/]), ::STRINGS[77/*"get: functi...*/]), ::STRINGS[78/*"var obs = g...*/]), ::STRINGS[79/*"if ("*/]), rawField), ::STRINGS[80/*" != obs) {"*/]), rawField), ::STRINGS[81/*" = obs;"*/]), propField), ::STRINGS[82/*" = obs"*/]), p->Modifier), ::STRINGS[83/*";"*/]), ::STRINGS[27/*"}"*/]), ::STRINGS[84/*"return "*/]), propField), ::STRINGS[27/*"}"*/]), ::STRINGS[85/*"})"*/]), ::STRINGS[85/*"})"*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[86] = uString::Const("{Resource ");
    ::STRINGS[38] = uString::Const("} not found in data context");
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(uPtr(_origin)->Parent())->TryGetResource(_key, uDelegate::New(::TYPES[69/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ...
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[86/*"{Resource "*/], _key), ::STRINGS[38/*"} not found...*/]), _origin);
}
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[87/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(i)));
...
static void Observable__Subscription_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\1.0.2\\$.uno");
    ::STRINGS[90] = uString::Const("SetExclusive");
    ::STRINGS[91] = uString::Const("setValueWithOrigin");
    ::STRINGS[92] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[28] = ::g::Fuse::IArray_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::ScriptException_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[61/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[19/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uObject* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[88/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[19/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[89/*"Unexpected ...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 646, ::STRINGS[90/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[91/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_worker)->Unwrap(newValue), uBox<int>(::TYPES[19/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[92/*"Failed to s...*/], ex, this, ::STRINGS[5/*"C:\\Users\\...*/], 661, ::STRINGS[90/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    ::STRINGS[93] = uString::Const("Name table missing 'this' pointer");
    ::STRINGS[94] = uString::Const("this");
    ::TYPES[27] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
}
...
void This__GetValue_fn(This* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[93/*"Name table ...*/]));
}
...
{
    return *__retval = ::STRINGS[94/*"this"*/], void();
}
...
{
    ::STRINGS[95] = uString::Const("Skipped Exception");
    ::STRINGS[5] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Reactive.JavaScript\\1.0.2\\$.uno");
    ::STRINGS[96] = uString::Const("CheckAndThrow");
    ::STRINGS[97] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[98] = uString::Const("CreateMirror");
    ::STRINGS[99] = uString::Const("Cannot use object of type '");
    ::STRINGS[100] = uString::Const("' as 'this' in JavaScript module; must be 'IProperties' or 'App'");
    ::STRINGS[101] = uString::Const("external_object");
    ::STRINGS[102] = uString::Const(" (ScriptClass)");
    ::STRINGS[103] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[104] = uString::Const("(set-superclass)");
    ::STRINGS[105] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[31] = uString::Const(".");
    ::STRINGS[55] = uString::Const(" (ScriptMethod)");
    ::STRINGS[106] = uString::Const("(function(cl, Observable) { cl.prototype.");
    ::STRINGS[107] = uString::Const(" = ");
    ::STRINGS[108] = uString::Const("; })");
    ::STRINGS[109] = uString::Const("ThreadWorked failed");
    ::STRINGS[110] = uString::Const("Run");
    ::STRINGS[111] = uString::Const("Could not create script context");
    ::TYPES[30] = ::g::Uno::Type_typeof();
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[95/*"Skipped Exc...*/], next, this, ::STRINGS[5/*"C:\\Users\\...*/], 1861, ::STRINGS[96/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[97/*"JavaScript ...*/], this, ::STRINGS[5/*"C:\\Users\\...*/], 1431, ::STRINGS[98/*"CreateMirror"*/]);
        return NULL;
    }
...
::g::Fuse::Reactive::ClassInstance* ThreadWorker::GetClassInstance(uObject* obj, ::g::Uno::UX::NameTable* rootTable)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[99/*"Cannot use ...*/], ::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(uPtr(uPtr(rootTable)->This()))))), ::STRINGS[100/*"' as 'this'...*/])));
}
...
uObject* ThreadWorker::Reflect(uObject* obj)
{
    ...
    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[101/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[101/*"external_ob...*/]), ::TYPES[60/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[102/*" (ScriptCla...*/]), ::STRINGS[103/*"(function(e...*/]), ::TYPES[24/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::STRINGS[104/*"(set-superc...*/], ::STRINGS[105/*"(function(c...*/]), ::TYPES[24/*Fuse.Scripting.Function*/]);
    ...
    for (int i = 0; i < uPtr(sc->Members())->Length(); i++)
    {
        ...
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[31/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[55/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[106/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[107/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[108/*"; })"*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[109/*"ThreadWorke...*/], e, this, ::STRINGS[5/*"C:\\Users\\...*/], 1757, ::STRINGS[110/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
        ...
        if (ThreadWorker::_context() == NULL)
        {
            ...
            if (ThreadWorker::_context() == NULL)
                U_THROW(::g::Uno::Exception::New2(::STRINGS[111/*"Could not c...*/]));
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"("*/], __this->First()), ::STRINGS[87/*", "*/]), __this->Second()), ::STRINGS[87/*", "*/]), __this->Third()), ::STRINGS[11/*")"*/]), void();
}
// }
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"("*/], __this->First()), ::STRINGS[87/*", "*/]), __this->Second()), ::STRINGS[87/*", "*/]), __this->Third()), ::STRINGS[87/*", "*/]), __this->Fourth()), ::STRINGS[11/*")"*/]), void();
}
// }
