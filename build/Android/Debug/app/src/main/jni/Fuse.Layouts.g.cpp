...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Controls.Panels\1.0.2\layouts\$.uno
// ------------------------------------------------------------------------------------------
...
static void GridLayout_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Panels\\1.0.2\\layouts\\$.uno");
    ...
    ::TYPES[31] = ::TYPES[15/*Uno.Collections.ICollection`1*/]->MakeType(::g::Fuse::Layouts::Row_typeof(), NULL);
    ::TYPES[32] = type->MakeMethod(4/*ModifyCount<Fuse.Layouts.Row>*/, ::g::Fuse::Layouts::Row_typeof(), NULL);
...
void GridLayout::ModifyCount(uType* __type, uObject* list, int count, ::g::Fuse::Layouts::DefinitionBase* primordial)
{
    ...
    if (count < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"RowCount an...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 1116, ::STRINGS[2/*"ModifyCount"*/], NULL);
        return;
    }
...
{
    return ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(RowList()), ::TYPES[31/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]));
}

// public void set_RowCount(int value) [instance] :1093
void GridLayout::RowCount(int value)
{
    ModifyCount(::TYPES[32/*Fuse.Layouts.GridLayout.ModifyCount<Fuse.Layouts.Row>*/], (uObject*)_rows, value, _defaultRow);
}
