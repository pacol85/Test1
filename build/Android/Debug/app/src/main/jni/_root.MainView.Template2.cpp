...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"editHike"*/]);
}
...
{
    ::g::EditHikePage* __self1 = ::g::EditHikePage::New6(uPtr(__this->__parent1)->router);
