...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Testing\1.0.2\$.uno
// --------------------------------------------------------------------------
...
{
    ::STRINGS[0] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.0.2\\$.uno");
...
{
    ::g::Uno::Testing::Assert::Fail(_message, ::STRINGS[0/*"C:\\Users\\...*/], 34, ::STRINGS[1/*"Fail"*/]);
}
