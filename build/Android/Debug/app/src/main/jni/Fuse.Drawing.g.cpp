...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Drawing.Surface\1.0.2\$.uno
// ----------------------------------------------------------------------------------
...
static void AndroidSurface_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Drawing.Surface\\1.0.2\\$.uno");
...
void AndroidSurface__DisposePath_fn(AndroidSurface* __this, ::g::Fuse::Drawing::SurfacePath* path)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"Duplicate d...*/], path, ::STRINGS[1/*"C:\\Users\\...*/], 585, ::STRINGS[2/*"DisposePath"*/]);
        return;
    }
...
void AndroidSurface__Prepare_fn(AndroidSurface* __this, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Unsupported...*/], brush, ::STRINGS[1/*"C:\\Users\\...*/], 479, ::STRINGS[7/*"Prepare"*/], NULL);
}
...
void AndroidSurface::DrawPath(::g::Java::Object* path, ::g::Fuse::Drawing::Brush* fill, int fillRule, ::g::Java::Object* paint)
{
    ...
    if (linearGradient != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"Unprepared ...*/], fill, ::STRINGS[1/*"C:\\Users\\...*/], 218, ::STRINGS[4/*"DrawPath"*/]);
            return;
        }
    ...
    if (imageFill != NULL)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Unprepared ...*/], fill, ::STRINGS[1/*"C:\\Users\\...*/], 234, ::STRINGS[4/*"DrawPath"*/]);
            return;
        }
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Unsupported...*/], fill, ::STRINGS[1/*"C:\\Users\\...*/], 255, ::STRINGS[4/*"DrawPath"*/], NULL);
}
...
void AndroidSurface::PrepareImageFill(::g::Fuse::Drawing::ImageFill* img)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Recieved an...*/], uBox(::g::Uno::Int2_typeof(), uPtr(src)->PixelSize()), ::STRINGS[1/*"C:\\Users\\...*/], 146, ::STRINGS[9/*"PrepareImag...*/], NULL);
        return;
    }
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Drawing\1.0.2\$.uno
// --------------------------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Drawing\\1.0.2\\$.uno");
    ::STRINGS[7] = uString::Const("Prepare");
    type->SetFields(1,
...
{
    if (!IsPinned())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Brush is no...*/], this, ::STRINGS[13/*"C:\\Users\\...*/], 71, ::STRINGS[7/*"Prepare"*/]);
...
void DrawObjectWatcher::Sync()
{
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Sync while ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 2856, ::STRINGS[16/*"Sync"*/]);
        return;
    }
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Elements\1.0.2\drawing\$.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Drawing\1.0.2\brushes\$.uno
// ----------------------------------------------------------------------------------
