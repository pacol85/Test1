...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Scripting\1.0.2\$.uno
// ----------------------------------------------------------------------------
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("../../AppData/Local/Fusetools/Packages/Fuse.Scripting/1.0.2/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[23/*"this.Contex...*/], ::STRINGS[24/*"../../AppDa...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[34] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting\\1.0.2\\$.uno");
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], path), ::STRINGS[33/*" was fixed!"*/]), this, ::STRINGS[34/*"C:\\Users\\...*/], 1879, ::STRINGS[35/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[32/*"JavaScript ...*/], path), ::STRINGS[36/*" line "*/]), uBox<int>(::TYPES[45/*int*/], uPtr(e)->LineNumber())), ::STRINGS[37/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[34/*"C:\\Users\\...*/], 1889, ::STRINGS[35/*"Require"*/], NULL);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[44/*"Cannot call...*/], __this, ::STRINGS[34/*"C:\\Users\\...*/], 1582, ::STRINGS[45/*"Call"*/]);
            return *__retval = NULL, void();
        }
