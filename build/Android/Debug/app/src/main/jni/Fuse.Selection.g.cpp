...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Selection\1.0.2\$.uno
// ----------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.0.2\\$.uno");
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[30/*"Unable to l...*/], __this, ::STRINGS[5/*"C:\\Users\\...*/], 965, ::STRINGS[31/*"Perform"*/], NULL);
        return;
    }
