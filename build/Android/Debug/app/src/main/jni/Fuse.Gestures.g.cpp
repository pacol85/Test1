...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.0.2\$.uno
// ---------------------------------------------------------------------------
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.0.2\internal\$.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\flozano\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.0.2\$.uno
// --------------------------------------------------------------------------------------
...
static void Scroller_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.0.2\\$.uno");
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Invalid scr...*/], NULL, ::STRINGS[2/*"C:\\Users\\...*/], 481, ::STRINGS[3/*"OnUpdated"*/]);
        return;
    }
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"C:\\Users\\...*/], 245, ::STRINGS[5/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"C:\\Users\\...*/], 252, ::STRINGS[5/*"UpdatePoint...*/]);
        else
        {
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("C:\\Users\\flozano\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\1.0.2\\$.uno");
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[11/*"Element"*/], __this->Parent(), __this, ::STRINGS[12/*"C:\\Users\\...*/], 1158, ::STRINGS[13/*"OnRooted"*/]);
        return;
    }
